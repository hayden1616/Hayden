...
class App(SimpleHTTPRequestHandler):
  ...
  def do_GET(self):
    ...
    if p.path in ('/products','/industries','/cases','/insights','/faq','/about','/admin') or p.path.startswith('/products/'):
